---
id: get-account-standing-orders
title: "Get Account Standing Orders"
description: "Retrieve standing orders for a specific account"
sidebar_label: "Get Account Standing Orders"
hide_title: true
...
<div className="api-method get">
  <div className="api-method__header">
    ...
    <span className="api-method__path">/accounts/\{accountId\}/standing-orders</span>
  </div>
</div>

Returns the standing orders of the specified account.
...
```json
{
  "standingOrders": [
    {
      "standingOrderId": "SO-2024-001",
      "frequency": "MONTHLY",
      "reference": "Rent Payment",
      "firstPaymentDate": "2024-01-01",
      "nextPaymentDate": "2024-04-01",
      "lastPaymentDate": "2024-12-01",
      "finalPaymentDate": "2024-12-01",
      "standingOrderAmount": {
        "amount": "2500.00",
        "currency": "CHF"
      },
      ...
      "creditorName": "Immobilien AG Zürich",
      "creditorAddress": {
        "structured": {
          "postCode": "8001",
    ...
    {
      "standingOrderId": "SO-2024-002",
      "frequency": "QUARTERLY",
      "reference": "Insurance Premium",
      "firstPaymentDate": "2024-01-01",
      "nextPaymentDate": "2024-04-01",
      "lastPaymentDate": "2024-12-31",
      "finalPaymentDate": "2024-12-31",
      "standingOrderAmount": {
        "amount": "450.00",
        "currency": "CHF"
      },
      ...
      "creditorName": "Swiss Insurance AG",
      "creditorAddress": {
        "structured": {
          "postCode": "8001",
          "streetName": "General-Guisan-Quai",
          "townName": "Zürich",
          "buildingNumber": "38",
          "country": "CH"
        }
      },
      "purpose": "Quarterly health insurance premium",
      "category": "INSURANCE",
      "status": "ACTIVE"
    }
  ]
